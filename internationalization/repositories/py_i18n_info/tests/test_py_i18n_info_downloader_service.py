...
def _check_data(path):
    ...
    assert len(files) == Pyi18nInfoDownloaderService._TEST_MODE_ITERATIONS
...
#
#     Pyi18nInfoDownloaderServiceMock().download_data(replace_semantic_data=False, test_mode=True)
#
#     for path in (region_tmp_path, language_tmp_path, script_tmp_path):
#         _check_data(path)
